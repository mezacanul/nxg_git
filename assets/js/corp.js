function addNewCorp() {
    var form = document.getElementById("corpDetails")
    ...
    if(form.checkValidity()){
        ...
        console.log(send);
        send.push({ name: "service", value: "add-corp"})
        console.log(send);
        // return
            ...
            try {
                ...
                if(response.status == "OK"){
                    if(response.added == 1){
                        ...
                        $(".status-info b").html("New Corp Added!")
                        $(".status-info").removeClass("d-none")
                        ...
                        $(".status-info b").html("Corp already exists...")
                        $(".status-info").removeClass("d-none")
